...
NwBuilder.prototype.copyAppFiles = function() {
    var self = this,
        copiedFiles = [];
    ...
    this._forEachPlatform(function (name, platform) {
        ...
        self._files.forEach(function (file) {
            ...
            copiedFiles.push(Utils.copyFile(path.resolve(file.src), path.resolve(platform.releasePath, destFile), self));
        });
    });
...
/*            copiedFiles.push(Utils.mergeFiles(
            ...
            /*            copiedFiles.push(Utils.copyFile(
             self.getZipFile(name),
             path.resolve(platform.releasePath, 'app.nw'),
             self
             ));*/
        }
    });
